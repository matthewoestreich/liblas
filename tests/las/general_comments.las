...
# this comment is meant for the well info section
# this comment is meant for the well info section
# this comment is meant for the well info section
~WELL INFORMATION
...
# this comment is meant for the STEP mnemonic inside Well Info
STEP .M -0.1250 :STEP
